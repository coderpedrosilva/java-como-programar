...
public class Ex100_PayrollSystemTest {
    public static void main(String[] args) {
        ...
        Ex96_SalariedEmployee salariedEmployee = new Ex96_SalariedEmployee("John", "Smith", "111-11-1111", 800.00);
        Ex97_HourlyEmployee hourlyEmployee = new Ex97_HourlyEmployee("Karen", "Price", "222-22-2222", 16.75, 40);
