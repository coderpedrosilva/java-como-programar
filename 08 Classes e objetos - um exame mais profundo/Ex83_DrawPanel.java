...
public class Ex83_DrawPanel extends JPanel {
    private SecureRandom randomNumbers = new SecureRandom();
    private Ex82_MyLine[] lines; // array de linhas

    // construtor, cria um painel com formas aleatórias
    public Ex83_DrawPanel() {
        setBackground(Color.WHITE);

        lines = new Ex82_MyLine[5 + randomNumbers.nextInt(5)];
        ...
        for (int count = 0; count < lines.length; count++) {
            ...
            lines[count] = new Ex82_MyLine(x1, y1, x2, y2, color);
        }
    }
